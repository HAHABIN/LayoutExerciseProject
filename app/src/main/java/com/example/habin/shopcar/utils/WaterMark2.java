...
public class WaterMark2 {
    ...
    private static WaterMark2 sInstance;//使用单例模式
    ...
    public static WaterMark2 getInstance() {
        if (sInstance == null) {
            synchronized (WaterMark2.class) {
                sInstance = new WaterMark2();
            }
        }
        return sInstance;
    }
    ...
    /** 设置水印文本 */
    public WaterMark2 setText(String text) {
        mText = text;
        return sInstance;
    }

    /** 设置水印时间 */
    public WaterMark2 setTime(String time) {
        mTime = time;
        return sInstance;
    }

    /** 设置透明度 */
    public WaterMark2 setAlpha(int alpha) {
        mAlpha = alpha;
        return sInstance;
    }

    /** 设置字体颜色 */
    public WaterMark2 setTextColor(int color) {
        mTextColor = color;
        return sInstance;
    }

    /** 设置字体大小 */
    public WaterMark2 setTextSize(float size) {
        mTextSize = size;
        return sInstance;
    }

    /** 设置旋转角度 */
    public WaterMark2 setRotation(float degrees) {
        mRotation = degrees;
        return sInstance;
    }
